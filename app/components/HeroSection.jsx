      ...
      >
        {!videoError ? (
          ...
          >
            ...
            <img src="/tech-fallback.jpg" alt="Technology background" />
          </video>
        ) : (
          <img
            src="/tech-fallback.jpg"
      ...
      <div className="relative z-10 px-6 sm:px-12 lg:px-24 max-w-7xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-gray-200 max-w-3xl mx-auto mb-10">
            ...
            in engineering, IT, and emerging technologies
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            ...
            <Link
              href="/contact"
              className="bg-transparent hover:bg-white/20 text-white px-8 py-4 rounded-lg text-lg font-semibold border border-white hover:border-transparent transition-all duration-300"
            >
              Get Consultation
            </Link>
          </div>
